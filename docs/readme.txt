...
7. Your code must output the original grid and solution grid
8. Solution grid must mark visited cells and actual path taken using the relevant symbols given below
...
3. no diagonal moves
4. read grid from a file
5. code will be tested against several maps 
6. one example grid and solution is given below
